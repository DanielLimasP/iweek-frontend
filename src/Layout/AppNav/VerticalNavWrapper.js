...
import {MainNav, ComponentsNav, ChartsNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <h5 className="app-sidebar__heading">Indicadores de turismo</h5>
                ...
                <h5 className="app-sidebar__heading">Graficos y tablas</h5>
